...
def format_context(hits: list[Hit], query: str | None = None,
    ...
    for i, h in enumerate(hits, 1):
        ...
        if no_points and rtype in (None, "operations"):
            ...
            lines.append("    Балльная оценка: у показанных требований баллы НЕ ПРИВЕДЕНЫ. Так и "
                         "скажи — «баллы по этой позиции не приведены, сверьте с первоисточником»; "
                         "не утверждай ни что баллов нет в приложении, ни что порог набирается.")
        if attribution_line:
