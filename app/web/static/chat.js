...
// а просто устаревший текст. Тот же класс, что найден в этом же файле у фолбэка (`dataset.raw`
// не выставлялся, и ответ нельзя было скопировать) — молча и без единого исключения.
