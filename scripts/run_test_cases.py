...
def main() -> None:
    ...
    md = ["# Приёмочные кейсы — Навигатор ПП №719\n",
          "Реальный вывод сервиса (0.5.0, база под ред. ПП №719 от 01.07.2026). Колонки «Оценка "
          "эксперта» и «Комментарий» — заполняются экспертом Курской ТПП. Критерий приёмки: доля "
          "ответов с оценкой ≥4★ ≥70% (см. docs/TESTING.md).\n",
