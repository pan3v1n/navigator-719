...
## Текущий статус
**Версия `0.5.0` — движок навигатора готов, идём к продукту `1.0`.** В Qdrant 1353 точки
...
**Цель `1.0` (архитектурное решение 2026-06-29): рабочий ассистент-эксперт по 719 в формате окна
диалога с LLM** (как ChatGPT) — чат-интерфейс, многоходовость, развёртывание, приёмка эксперта
(≥70%). Всё остальное (валидатор/калькулятор, акты, масштаб) — `2.0`+.
Запуск: [docs/LAUNCH.md](docs/LAUNCH.md). Детальный план по версиям — в **ROADMAP.md**.
