...
## Текущий статус
**Версия `0.5.0`; движок готов, продукт мини-1.0 собран и отполирован — осталось развернуть.**
_Движок:_ в Qdrant 1357 точек (29 разделов приложения), гибрид-поиск + буст по ОКПД2 + LLM-реранкер,
...
**СЛЕД. ШАГ — деплой docker-compose на Yandex Cloud (грант) → приёмка эксперта.**
